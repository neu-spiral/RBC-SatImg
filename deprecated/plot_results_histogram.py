...
path_results = os.path.join(r"/Users/helena/Documents/test/evaluation_results/histogram_prediction", f'{Config.scenario}_{Config.test_site}')
...
# Plot plot_figures for Oroville Dam scenario
...
pickle_file_path = os.path.join(path_results, f"oroville_dam_{Config.test_site}_image_{n_image_to_plot}_epsilon_{epsilon_value}_norm_constant_{Config.norm_constant}.pkl")
...
f.suptitle(f"Histogram posterior all samples date {date_string}, epsilon {epsilon_value}, {Config.scenario} {Config.test_site}, norm constant = {Config.norm_constant}")

# Save figure as pdf
if Debug.save_figures:
    path_image_save = os.path.join(Config.path_figures, f'histogram_likelihood_{Config.scenario}_{Config.test_site}_epsilon_{epsilon_value}_norm_constant_{Config.norm_constant}.pdf')
