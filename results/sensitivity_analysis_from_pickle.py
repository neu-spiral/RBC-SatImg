...
for idx_model, model in enumerate(models_to_plot):
    ...
    # Add x and y labels
    axarr[idx_model].set_title(model, fontsize=14, fontname='Times New Roman')
...
leg = axarr[0].legend(epsilon_to_plot_legend, ncol=len(epsilon_to_plot), loc='upper center', bbox_to_anchor=(0.5, 1.4),
                  prop=font)
